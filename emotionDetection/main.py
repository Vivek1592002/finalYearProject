...
@app.route('/')
def index():
    face_classifier = cv2.CascadeClassifier(r'C:\Users\Vivek Shekhawat\Desktop\final year project\Emotify-Arithemania\emotionDetection\haarcascade_frontalface_default.xml')
    classifier =load_model(r'C:\Users\Vivek Shekhawat\Desktop\final year project\Emotify-Arithemania\emotionDetection\model.h5')
    ...
    print(val)
    fp = open(r"C:\Users\Vivek Shekhawat\Desktop\final year project\Emotify-Arithemania\new.txt","w")
    fp.write(val)
    fp.close()
    import os
    os.system(r'python "C:\Users\Vivek Shekhawat\Desktop\final year project\Emotify-Arithemania\songRecommender\test.py"')
